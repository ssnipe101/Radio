# Radio 
Currently only supports .mp3 and .flac.

Run once for setup. Then shut it down and follow the steps below. 

**On first run it creates a folder called RadioData in the same location as the executable.**
**Inside RadioData there is a folder called Music. Put the music files in here. There can be subfolders.**
